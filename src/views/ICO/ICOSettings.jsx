...
import { PanelHeader, Button, CardIcon, ImageUpload } from "components";

class ICOSettings extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      register: {
  ...
  registerPassword(e) {
    ...
    this.state.register.minLengthState
    this.setState({ register });
  }
  registerConfirm(e) {
    var register = this.state.register;
          ...
          <Row>
            <Col xs={12} md={6}>
              <Form>
                <Card>
                  <CardHeader>
                    <CardTitle>Set Withdrawal Wallet</CardTitle>
                  </CardHeader>
                  <CardBody>
                    <FormGroup
                ...
                <Card>
                  ...
                  <CardBody>
                    ...
                    <div className="category form-category">
                      <code>Should be longer than 6 letters.</code><br/>
                      <code>Should contain at least one digit.</code><br/>
                      <code>Should contain at least one special character.</code><br/>
                    </div>
                  </CardBody>
              ...
              <Row>
                  ...
                  <Form>
                    <Card>
                      ...
                      <CardBody>
                        ...
                        <FormGroup
                          className={"has-label " + this.state.type.numberState}
                        >
                ...
                <Col xs={12} md={5}>
                  <Card className="card-pricing">
                    ...
                    <h6 className="card-category"> unverified</h6>
                    <CardBody>
                      <CardIcon
                        color="primary"
                      ...
                      />
                      <ul>
                        <li>KYC will be required.</li>
                        <li>You can only withdraw SRT if you pass it.</li>
                      </ul>
                    </CardBody>
                    <CardFooter>
